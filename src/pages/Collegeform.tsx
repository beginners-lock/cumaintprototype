...
export default function Collegeform() {
    ...
    const proceed = () => {
        clearErrors();
        let cbuidling = document.getElementById('cbuildingselect') as HTMLSelectElement;
        ...
        if(!cbuidling.value){ error = true; setCbuildingerr(true); }
        ...
        if(!error){
            ...
            updatedform.specifics1 = cbuidling.value;
    ...
    <div>
        ...
        <div className="pt-20 w-full flex flex-row items-start justify-center">
            <div className="w-[500px] py-8 px-10 h-auto text-center rounded-lg shadow-xl bg-white mr-10" style={{border:'2px solid rgba(228, 231, 236, 1)'}}>
                <div>
                    <div className="text-lg font-bold">College Building Form</div>
                ...
                <div>
                    <div className="flex flex-col items-start justify-start mt-4">
                        <label className="text-xs font-semibold mb-2 flex flex-row items-center justify-start">
                            College Building
                            <div className="w-1 h-1 bg-red-700 rounded-full ml-2" style={{display:cbuildingerr?'flex':'none'}}></div>
                        </label>
                        <select id="cbuildingselect" className="h-10 w-full text-sm rounded-md px-2" style={{border:'1px solid grey'}}>
                            <option value="" >Select the College Building</option>
                            <option value="CLDS Building">CLDS Building</option>
                            <option value="CMSS Building">CMSS Building</option>
                            <option value="CST Building">CST Building</option>
                            <option value="Petroluem/Chemical Engr. Building">Petroluem/Chemical Engr. Building</option>
                            <option value="Mechanical Engr. Building">Mechanical Engr. Building</option>
                            <option value="Civil Engr. Building">Civil Engr. Building</option>
                            <option value="EIE Building">EIE Building</option>
