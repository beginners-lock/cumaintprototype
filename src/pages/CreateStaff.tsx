...
import { STAFF_CREATE_ACC_INSTRUCTIONS, EMAIL_ALREADY_REGISTERD, ACCOUNT_CREATED } from "../constants/messages.tsx";
...
export default function CreateStaffAcount() {
    ...
    const createaccount = () => {
        ...
        if(password==='' || password.length<8){
            error=true; setPassworderr(true); setErrbody(STAFF_CREATE_ACC_INSTRUCTIONS);
        }
